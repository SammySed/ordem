        ...
        <div class="user-block block">
            ...
            <?php if (empty($gruposDisponiveis)) : ?>
                ...
                <?php else : ?>
                    ...
                    <p class="contributions text-white mt-0">Esse usuário já faz parte de um grupo Administrador. Para associá-lo a outros grupos, primeiro remova-o do grupo de Administrador!</p>
                        ...
                        <tbody>
                            <?php foreach ($usuario->grupos as $info) : ?>
                                <tr>
                                    ...
                                    <td><?php echo ellipsize($info->descricao, 120, .5); ?></td>
                                    <td>
                                        <?php
                                        $atributos  = [
