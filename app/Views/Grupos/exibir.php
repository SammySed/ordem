    ...
    <?php if ($grupo->id < 3) : ?>
        <div class="col-md-12">
            ...
            <div class="alert alert-info" role="alert">
                ...
                <p>O grupo <b><?php echo esc($grupo->nome); ?></b> não pode ser editado ou excluido, pois os mesmos não podem ter suas permissões revogadas</p>
                <hr>
        ...
        <div class="user-block block">
            ...
            <p class="contributions mt-0"><?php echo $grupo->exibeSituacao(); ?>
                <?php if ($grupo->deletado_em == null) : ?>
                    ...
                    <a tabindex="0" style="text-decoration: none;" role="button" data-toggle="popover" data-trigger="focus" title="Importante" data-content="Esse grupo <?php echo ($grupo->exibir == true ? 'será' : 'não será'); ?> exibido como opção na hora de definir um <b>Responsável</b> pela ordem de serviço">&nbsp;&nbsp;<i class="fa fa-question-circle fa-lg text-danger"></i></a>
                ...
                <div class="btn-group mr-2">
                    ...
                    <div class="dropdown-menu">
                        ...
                        <?php if ($grupo->id > 2) : ?>
                            ...
                            <a class="dropdown-item" href="<?php echo site_url("grupos/permissoes/$grupo->id"); ?>">Gerenciar as permissões do grupo de acesso</a>
