    ...
    <?php if ($item->id === null) : ?>
        ...
        <div class="col-md-4 mb-5">
            ...
            <!-- <div class="custom-control custom-radio">
                <input type="radio" class="custom-control-input" id="produto" name="tipo" value="produto" >
                <label class="custom-control-label" for="produto"><i class="fa fa-archive text-success" aria-hidden="true"></i>&nbsp; Produto</label>
            </div> -->

            <div class="custom-control custom-radio">
                <input type="radio" class="custom-control-input" id="servico" name="tipo" value="serviço" checked>
                <label class="custom-control-label" for="servico"><i class="fa fa-handshake-o text-white" aria-hidden="true"></i>&nbsp;Novo Serviço</label>
            </div>
...
<div class="row">
    ...
    <div class="form-group col-md-12">
        ...
        <textarea name="descricao" class="form-control" rows="4"><?php echo esc($item->descricao); ?></textarea>
