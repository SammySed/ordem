        ...
        <div class="block">
            ...
            <div class="block-body">
                ...
                <?php if (count($item->imagens) >= 10) : ?>
                    ...
                    <p class="contributions text-danger mt-o">Esse produto já possui as
                        <?php echo count($item->imagens) ?> imagens permitidas.<br>
                        Para inserir novas imagens, você precisa remover alguma das existentes.
                    </p>
    ...
    <div class="col-lg-7">
        ...
        <div class="user-block block">
            ...
            <?php if (empty($item->imagens)) : ?>
                ...
                <p class="contributions text-warning mt-o">Esse item ainda não possui nenhuma imagem!</p>
