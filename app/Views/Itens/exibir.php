            ...
            <div class="btn-group">
                ...
                <div class="dropdown-menu">
                    ...
                    <?php else : ?>
                        ...
                        <a class="dropdown-item" href="<?php echo site_url("itens/desfazerexclusao/$item->id") ?>">Restaurar item</a>
    ...
    <div class="col-lg-8">
        ...
        <div class="user-block block">
            ...
            <p class="contributions">
                Histórico de alteração do item
            </p>

            <?php if (isset($item->historico) === false) : ?>

                <p class="contributions">
                    <span class="text-white">Item não possui historio de alterações</span>
                </p>
                    ...
                    <?php foreach ($item->historico as $key => $historico) : ?>
                        ...
                        <div class="card">
                            <div class="card-header" id="heading-<?php echo $key ?>">
                                <h5 class="mb-0">
                                    <button class="btn btn-link text-danger" data-toggle="collapse" data-target="#collapse-<?php echo $key ?>" aria-expanded="true" aria-controls="collapse-<?php echo $key ?>">
                            ...
                            <div id="collapse-<?php echo $key ?>" class="collapse <?php echo ($key === 0 ? 'show' : ''); ?>" aria-labelledby="heading-<?php echo $key ?>" data-parent="#accordion">
                                <div class="card-body">
                                    ...
                                    <p>Em <?php echo date('d/m/Y H:i', strtotime($historico['criado_em'])) ?>
                                        <br>
                                        O item sofreu uma <span class="text-white"><?php echo esc($historico['acao']); ?></span>, de usuário(a) <span class="text-white"><?php echo esc($historico['usuario']); ?></span>
                                    </p>
